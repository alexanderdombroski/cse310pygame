...
class Fire(sprite.Sprite):
    ...
    def move(self):
        if self.rotation_degrees_ccw == 0:
            ...
            #     self.rect.y -= 1
            #     only_once = False
            if - self.rect.top + self.start_y < self.full_height:
        ...
        if self.rotation_degrees_ccw == 90:
            if - self.rect.left + self.start_x < self.full_height:
        ...
        if self.rotation_degrees_ccw == 180:
            if self.rect.bottom - self.start_y < self.full_height:
        ...
        if self.rotation_degrees_ccw == 270:
            if self.rect.right - self.start_x < self.full_height:
